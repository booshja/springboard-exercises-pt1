...
SELECT category, COUNT(*) AS number_apps FROM analytics GROUP BY category;
...
SELECT * FROM analytics WHERE min_installs <= 50 AND rating BETWEEN 0 AND 5 ORDER BY price desc;
